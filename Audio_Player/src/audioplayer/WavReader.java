...
public class WavReader {
    ...
    public WavReader(File data) throws FileNotFoundException {
        audio = new FileInputStream(data);
        read();
        fmt = getFormat();
    }
    ...
    public WavReader(String path) throws FileNotFoundException {
        //filePath = path;
